...
8pRchr$(156):w$="":input"enter number of words to generate (3-20)";w$
9passphrasesize=val(w$):ifpassphrasesize<3orpassphrasesize>20then8
10r=rnd(-ti):pRchr$(144):fork=1topassphrasesize:n=-lowoutcome
11fori=1tonumrolls:n=n+((int(rnd(1)*6)+1)*int(d(i))):next
12pRo$(n):next
13pRchr$(31):a$="":input"generate another passphrase (y/n)";a$
14ifa$<>"y"anda$<>"n"then13
15ifa$="n"then17
16goto8
17pRchr$(147)chr$(14)chr$(156);:end
